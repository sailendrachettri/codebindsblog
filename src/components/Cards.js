        ...
        <>
            <div className='container-fluid d-flex justify-content-center flex-wrap mt-3'>
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">History of NLP  <i className="bi bi-hand-index-thumb"></i> </Link>
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Large language model<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Transformers<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Inference Configuration<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Ollama<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Fine Tuning<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Retrieval augmented generation (RAG)<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Dataset<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Vector Database and Embeddings<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Essentials on LoRA, Quantization and Sharding Variants<i className="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">LLM Apps<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Language Processing Units (LPU)<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Pipeline<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">LLM Threats<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Cloud GPUs<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Explainable Artificial Intelligence<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Prompt engineering<i className="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
