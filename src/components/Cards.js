    ...
    return (
        <>
            <div className='container-fluid col-10 d-flex justify-content-start flex-wrap mt-3'>
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Large language model<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Transformers<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Inference Configuration<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Ollama<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Fine Tuning<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Retrieval augmented generation (RAG)<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Dataset<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Vector Database and Embeddings<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">Essentials on LoRA, Quantization and Sharding Variants<i class="bi bi-hand-index-thumb"></i> </Link>
                    <div className="card-body text-secondary">
                ...
                <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                    <Link to="#" className="card-header text-primary text-decoration-none">LLM Apps<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Language Processing Units (LPU)<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Pipeline<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">LLM Threats<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Cloud GPUs<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Explainable Artificial Intelligence<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
            ...
            <div className="card border-secondary mb-3 mx-2" style={{ maxWidth: "18rem" }}>
                <Link to="#" className="card-header text-primary text-decoration-none">Prompt engineering<i class="bi bi-hand-index-thumb"></i> </Link>
                <div className="card-body text-secondary">
