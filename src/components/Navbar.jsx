        ...
        <>
            <nav className="navbar navbar-expand-lg bg-body-tertiary py-3">
                <div className="container-fluid">
                    <Link className="navbar-brand" to="/" onClick={handleProgress}><i className="bi bi-boxes"></i> CODEBINDS</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" target='_blank' to="https://codebinds.blinkstore.in"><i className="bi bi-cart3"></i> Store</Link>
                            </li>
                        </ul>
